...
{	
	unset($_SESSION['dangnhap_home']);/// bo sesion
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<a href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>" class="text-white">
								<i class="fas fa-user-circle mr-2"></i>Xin chào : <?php echo $_SESSION['dangnhap_home'] ?></a>
						</li>
							<li class="text-center border-right text-white">
							<a href="?ac=dangxuat" class="text-white">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="#" method="post">
						...
						<div class="right-w3l">
							<input type="submit" class="form-control" name="dangnhap_ ome" value="Đăng nhập">
						</div>
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.php" class="font-weight-bold font-italic">
							<img src="images/logo2.png" alt=" " class="img-fluid">Shop Online
						</a>
					</h1>
				</div>
				<!-- //logo -->
