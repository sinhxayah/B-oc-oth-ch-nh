										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												...
												<fieldset>
													...
													<input type="submit" name="themgiohang" value="Thêm giỏ hàng" onclick="show_alert();" class="button" />
												</fieldset>
											</form>
											</div>
										</div>
	...
	?>
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<a href="?quanly=chitietsp&id=<?php echo $row_sanpham_sidebar['sanpham_id'] ?>" title=""><img src="images/<?php echo $row_sanpham_sidebar['sanpham_image'] ?>" alt="" class="img-fluid"></a>
										</div>
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											<a href="?quanly=chitietsp&id=<?php echo $row_sanpham_sidebar['sanpham_id'] ?>"><?php echo $row_sanpham_sidebar['sanpham_name'] ?></a>
											<a href="?quanly=chitietsp&id=<?php echo $row_sanpham_sidebar['sanpham_id'] ?>" class="price-mar mt-2"><?php echo number_format($row_sanpham_sidebar['sanpham_giakhuyenmai']) . 'vnđ' ?></a>
